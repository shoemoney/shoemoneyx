...
| Arena / .smx-arena | STRATEGY ARENA + Arena | Keep the actual ArenaFight visualization and ArenaBook. Frame champion summary and fight viewport with cyan edge reflections and black background. Make train/test values larger, champion details >=13px. Side/coin controls wrap on phones. Retain red for short/risk and existing meaningful promotion colors; blue is the shared structure. |
