...
apt-get update -y
apt-get install -y --no-install-recommends \
  php8.4 php8.4-fpm php8.4-cli php8.4-mysql php8.4-redis php8.4-bcmath \
  php8.4-sodium php8.4-intl php8.4-zip php8.4-mbstring php8.4-xml php8.4-curl php8.4-gd php8.4-opcache
